...
/**
 * com.epam.Horse class defines the behavior of a com.epam.Horse.
 ...
 * {@code runTime} starts when com.epam.Horse began run. It is needed to count the run time later.
...
public class Horse implements Callable<Horse> {
     ...
     * @return  com.epam.Horse that finished the run.
     */
    @Override
    public Horse call() {
